...
-- map('n', '[d', vim.diagnostic.goto_prev, { 'Go to previous [D]iagnostic message' })
	...
	s = { -- {{{ s
      ...
      -- },
		...
		['S'] = { "<cmd>Telescope git_files search_dirs={'~/.config/nvim/lua/skogix/'}<cr>", '[search] lua/skogix files' },
		['s'] = { "<cmd>Telescope find_files search_dirs={'~/.config/nvim/lua/skogix/'}<cr>", '[search] lua/skogix files' },
