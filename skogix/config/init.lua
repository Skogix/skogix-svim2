---@module skogix.config
--- This module is responsible for setting up the configuration for sVim.
...
--- This module also provides a function to load specified configuration files from lua/skogix/config/* and lua/config/* directories.
--- It also serves as the main entry-point once lazy.nvim is set-up and is called from `lua/skogix/plugins/init.lua`.
...
---@param name string The name of the configuration file to load. It can be 'autocmds', 'options', or 'keymaps'.
