...
return {
            ...
            dap.configurations.cpp = {
                {
                    ...
                    type = "lldb",
                    request = "launch",
                    -- program = '/home/emile/repos/all/core/build/cache/cook/gcc-x64-color-debug-gstreamer_1-427ec95e/ut.comp.apm.v1.protected',
                    program = "/home/emile/repos/all/core/build/cache/cook/clang-x64-color-debug-gstreamer_1-2b8de9fa/ut.comp.apm.v1.protected",
                    cwd = "${workspaceFolder}",
                    stopOnEntry = false,
                    args = { "--test-case=*[fast]*" },
                    -- 💀
    ...
    },
    {
        ...
        config = function()
            if IsNotAvailable("nvim-dap-virtual-text") then
                return
            end
