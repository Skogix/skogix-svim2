...
return {
	...
	-- Statusline plugin with many customizations.
	{
		...
		opts = function()
			...
			local SkogixUtil = require('skogix.util')
			...
			local active = {
				bg = SkogixUtil.ui.bg('StatusLine'),
				fg = SkogixUtil.ui.fg('StatusLine'),
			}
			local inactive = {
				bg = SkogixUtil.ui.bg('StatusLineNC'),
				fg = SkogixUtil.ui.fg('StatusLineNC'),
			}
			...
			local theme = {
				normal = {
					...
					c = active,
					x = {
						fg = SkogixUtil.color.brightness_modifier(active.bg, -80),
						bg = active.bg,
					},
					y = {
						fg = active.fg,
						bg = SkogixUtil.color.brightness_modifier(active.bg, -20),
					},
					z = {
						fg = active.fg,
						bg = SkogixUtil.color.brightness_modifier(active.bg, 63),
					},
				},
				inactive = {
					a = inactive,
			...
			return {
				...
				sections = {
					...
					lualine_b = {
						...
						{
							SkogixUtil.lualine.plugin_title(),
				...
				inactive_sections = {
					lualine_a = {
						...
						{ Util.lualine.pretty_path(), padding = { left = 1, right = 0 } },
						{
							...
							cond = is_file_window,
							padding = 1,
							color = { fg = SkogixUtil.ui.bg('DiffDelete') },
						},
					},
					lualine_b = {},
					lualine_c = {},
